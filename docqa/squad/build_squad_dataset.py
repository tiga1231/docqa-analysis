...
def main():
    ...
    parser.add_argument("--basedir", default='data_raw/squad')
    ...
    print("Parsing train...")
    train = list(parse_squad_data(join(args.basedir, args.train_file), "train", tokenzier))
    print("Parsing dev...")
    dev = list(parse_squad_data(join(args.basedir, args.dev_file), "dev", tokenzier))
